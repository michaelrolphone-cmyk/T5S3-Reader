...
- [Next hardware-test milestone U1](NEXT_HARDWARE_TEST_MILESTONE.md) — **read for all current USB, package, signing-purge, catalog, Serial Monitor or provider release work; task order, exact source targets, acceptance and one hardware test handoff**.
