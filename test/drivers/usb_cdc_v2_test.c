...
int main(int argc,char **argv){
 ...
 risc_usb_host_discovery_v1 host={{RISC_USB_HOST_API_V1,sizeof(host),0,configuration,claim,release_claim,control,bulk_read,bulk_write},0,0,checked_release,control};dep.api=&host.host;assert(!driver->start(&dep,1));
