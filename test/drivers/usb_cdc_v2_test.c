...
int main(int argc,char **argv){
 ...
 reject_config=true;assert(discovery->probe(2)<0&&claims==0&&controls==0);assert(!cdc->open(2));reject_config=false;reject_data=true;assert(!cdc->open(2)&&claims==1&&releases==1);reject_data=false;
